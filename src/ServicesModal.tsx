...
border border-zinc-800" style={{backgroundImage: "URL('./public/led-zeppelin-bbc-cover-negative-390x390.jpg')", padding: '2rem 2rem 7rem 2rem', position: "absolute", top: '10rem', scrollbarWidth: 'none'}}         >
            {/* HEADER */}
